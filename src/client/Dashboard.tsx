...
/* ---- Today: the weight readout block ---- */
...
/* ---- Body: shoulder:waist + measurements ---- */
    ...
    <>
      ...
      <section className="card">
        ...
        {orderedMeasurements.length === 0 ? (
          <p className="empty">no measurements yet — tap + Add</p>
        ) : (
          <div className="rows">
...
/* ---- Food: nutrition totals + food log ---- */
  ...
  return (
    <>
      <section className="card">
        ...
        {nutritionToday == null ? (
          <p className="empty">log today's intake — tap + Add</p>
        ) : (
          <div className="rows">
            <div className="crow">
              <div className="crow-top">
